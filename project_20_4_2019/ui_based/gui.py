...
firstclick = True
emoji_dict = {"joy":"joy.jpg", "fear":"fear.jpg", "anger":"anger.jpg", "sadness":"sad.jpg", "disgust":"disguist.jpg", "shame":"shame.jpg", "guilt":"guilt.jpg"}
...
def show_entry_fields():
    if e1.get("1.0",'end-1c')=="type a sentence..." or e1.get("1.0",'end-1c')=="":
        ...
        Label(window, text =mood[0]).grid(row=3,sticky=W+E+N+S)
        img_show.show_img(emoji_dict.get(mood[0]))
window = Tk()
