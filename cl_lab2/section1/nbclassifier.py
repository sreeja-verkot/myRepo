...
print("class of [5.0,2.0,3.5,1.0] predicted by Gaussian Naive Bayes: ",gnb.predict([[5.0,2.0,3.5,1.0]]))
print("class of [5.0,2.0,3.5,1.0] predicted by Multinominal Naive Bayes: ",clf.predict([[5.0,2.0,3.5,1.0]]))
